...
/**
 * Generated class for the InventarioInsumosPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-inventario-insumos',
  templateUrl: 'inventario-insumos.html',
})
export class InventarioInsumosPage {
  ...
  salvarAlteracao(ins : InsumolocalizacaoDTO){
   console.log(ins) 
   this.insumoService.updateInsumoLocalizacaoInventario(ins).subscribe(response => {
    this.showUpdateOk();
  },
  error => {});
  }
