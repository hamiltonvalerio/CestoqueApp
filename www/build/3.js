...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__directives_directives_module__ = __webpack_require__(753);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__cadastro_insumo__ = __webpack_require__(906);
...
var CadastroInsumoPageModule = /** @class */ (function () {
    ...
    CadastroInsumoPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_3__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_5__cadastro_insumo__["a" /* CadastroInsumoPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_5__cadastro_insumo__["a" /* CadastroInsumoPage */]),
                ...
                __WEBPACK_IMPORTED_MODULE_6_brmasker_ionic_3__["b" /* BrMaskerModule */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__hide_header_hide_header__ = __webpack_require__(754);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__app_module__ = __webpack_require__(908);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__directives__ = __webpack_require__(909);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__enums_tipoconsumo_enum__ = __webpack_require__(907);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__services_domain_insumo_service__ = __webpack_require__(356);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_brmasker_ionic_3__ = __webpack_require__(896);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CadastroInsumoPage = /** @class */ (function () {
    function CadastroInsumoPage(navCtrl, navParams, viewCtrl, alertCtrl, formBuilder, insumoService, categoriaService, loadingCtrl, brMaskerIonic3, unidadeService, orgaoService) {
        ...
        this.formGroup = this.formBuilder.group({
            ...
            nomenclatura: ['', [__WEBPACK_IMPORTED_MODULE_4__angular_forms__["g" /* Validators */].required]],
            valor: ['',],
            codigoalmox: ['',],
            observacao: ['',],
            essencial: [false,],
    ...
    Object.defineProperty(CadastroInsumoPage.prototype, "consumos", {
        get: function () {
            return this.formGroup.get("consumos");
        },
        enumerable: true,
        configurable: true
    });
    CadastroInsumoPage.prototype.ionViewDidLoad = function () {
        ...
        if (this.itemId != null) {
            ...
            this.insumoService.findInsumoById(this.itemId).subscribe(function (resp) {
                ...
                if (_this.updateInsumoDTO.consumos.length > 0) {
                    _this.updateInsumoDTO.consumos.forEach(function (c) {
                        _this.consumos.push(_this.createFormGroupArray(c));
                    });
                }
                console.log(_this.consumos);
                _this.formGroup = _this.formBuilder.group({
                    ...
                    consumos: _this.consumos.length > 0 ? _this.consumos : _this.formBuilder.array([_this.createFormGroup(_this.updateInsumoDTO)]),
                }, {});
            });
        }
    };
    CadastroInsumoPage.prototype.createFormGroupArray = function (consumo) {
        //aqui 
        console.log(this.getEnumKeyByEnumValue(__WEBPACK_IMPORTED_MODULE_0__enums_tipoconsumo_enum__["a" /* TipoConsumoEnum */], 1));
        return this.formBuilder.group({
            insumo: [consumo.insumo,],
            tipoconsumo: [__WEBPACK_IMPORTED_MODULE_0__enums_tipoconsumo_enum__["a" /* TipoConsumoEnum */][consumo.tipoconsumo_id],],
    ...
    CadastroInsumoPage.prototype.getEnumKeyByEnumValue = function (myEnum, enumValue) {
        var keys = Object.keys(myEnum).filter(function (x) { return myEnum[x] == enumValue; });
        return keys.length > 0 ? keys[0] : null;
    };
    CadastroInsumoPage.prototype.createFormGroup = function (insumo) {
        return this.formBuilder.group({
            insumo: [insumo,],
            tipoconsumo: new __WEBPACK_IMPORTED_MODULE_4__angular_forms__["b" /* FormControl */](),
            tipoconsumo_id: new __WEBPACK_IMPORTED_MODULE_4__angular_forms__["b" /* FormControl */](),
            unidadetipo: new __WEBPACK_IMPORTED_MODULE_4__angular_forms__["b" /* FormControl */](),
    ...
    CadastroInsumoPage.prototype.loadEnumTiposConsumos = function () {
        this.tiposconsumos = [];
        for (var _i = 0, _a = Object.entries(__WEBPACK_IMPORTED_MODULE_0__enums_tipoconsumo_enum__["a" /* TipoConsumoEnum */]); _i < _a.length; _i++) {
    ...
    CadastroInsumoPage.prototype.tipoConsumoChange = function (event) {
    };
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TipoConsumoEnum; });
var TipoConsumoEnum;
(function (TipoConsumoEnum) {
    TipoConsumoEnum[TipoConsumoEnum["MOVIMENTO"] = 1] = "MOVIMENTO";
    TipoConsumoEnum[TipoConsumoEnum["CONSUMO"] = 2] = "CONSUMO";
    TipoConsumoEnum[TipoConsumoEnum["ENTRADA"] = 3] = "ENTRADA";
    TipoConsumoEnum[TipoConsumoEnum["SAIDA"] = 4] = "SAIDA";
})(TipoConsumoEnum || (TipoConsumoEnum = {}));
//# sourceMappingURL=tipoconsumo.enum.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__directives_brmasker_ionic_3__ = __webpack_require__(897);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__directives_brmasker_ionic_services__ = __webpack_require__(898);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__brmasker_ionic_3__ = __webpack_require__(897);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__brmasker_ionic_services__ = __webpack_require__(898);
