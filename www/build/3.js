        ...
        if (this.itemId != null) {
            ...
            this.insumoService.findInsumoById(this.itemId).subscribe(function (resp) {
                ...
                _this.formGroup = _this.formBuilder.group({
                    ...
                    consumos: _this.formBuilder.array([_this.createFormGroup()]),
                }, {});
            });
        }
    };
    CadastroInsumoPage.prototype.createFormGroup = function () {
