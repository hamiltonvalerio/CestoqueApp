...
var CadastroInsumoPage = /** @class */ (function () {
            ...
            this.insumoService.findInsumoById(this.itemId).subscribe(function (resp) {
                ...
                if (_this.updateInsumoDTO.consumos.length > 0) {
                    _this.updateInsumoDTO.consumos.forEach(function (c) {
                        console.log("a2");
                        _this.consumos.push(_this.createFormGroupArray(c, _this.updateInsumoDTO));
                    });
                }
                console.log(_this.itemId);
                console.log("this.consumos");
                console.log(_this.consumos.length);
                _this.formGroup = _this.formBuilder.group({
                    ...
                    consumos: _this.consumos.length > 0 ? _this.consumos : _this.formBuilder.array([_this.createFormGroup(_this.updateInsumoDTO, "b")]),
                }, {});
            });
        }
    };
    ...
    CadastroInsumoPage.prototype.testeTipo = function (event) {
        console.log(__WEBPACK_IMPORTED_MODULE_0__enums_tipoconsumo_enum__["a" /* TipoConsumoEnum */].CONSUMO);
        this.t = event.value;
        console.log(this.t);
    };
