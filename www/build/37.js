...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__cadastro_localizacao__ = __webpack_require__(906);
        ...
        if (this.itemId != null) {
            this.localizacaoService.findLocalizacaoById(this.itemId).subscribe(function (resp) {
                ...
                _this.formGroup = _this.formBuilder.group({
                    ...
                    resultado: [_this.updateLocalizacaoDTO.resultado,],
                }, {});
                if (_this.updateLocalizacaoDTO.localizacaofilha != null) {
                    if (_this.updateLocalizacaoDTO.localizacaofilha == true) {
                        _this.fieldLocalizacaoFilha = false;
                    }
                }
            });
        }
