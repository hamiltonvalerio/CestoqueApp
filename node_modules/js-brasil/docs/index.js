  ...
  if (generatedAction) {
    generatedAction.onclick = () => {
      ...
      if (document.querySelector('#localidade')) {
        const val = document.querySelector('#localidade').value;
        const [estado, cidade] = val.split(';');
        generatedInput.value = jsbrasil.fakerBr[dataId](estado, cidade);
      } else {
  ...
  if (validatedAction) {
    validatedAction.onclick = () => {
      ...
      if (document.querySelector('#localidade')) {
        const val = document.querySelector('#localidade').value;
        const [estado, cidade] = val.split(';');
        validated = jsbrasil.validateBr[dataId](validatedInput.value, estado, cidade);
      } else {
        validated = jsbrasil.validateBr[dataId](validatedInput.value);
      }
