import { Component, Injectable, InjectionToken, Input, NgModule, forwardRef } from '@angular/core';
                ...
                providers: [
                    {
                        ...
                        useExisting: forwardRef(function () { return IonInputMaskComponent; }),
                        multi: true
                    }
                ]
            },] },
...
export { IonMaskModule, IonInputMaskComponent };
